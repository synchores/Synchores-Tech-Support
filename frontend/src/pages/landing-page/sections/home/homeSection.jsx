...
export default function Home() {
  ...
  const activeVideoSrc = useMemo(() => {
    ...
    if (videoFallbackLevel === 0 && cmsSrc) return cmsSrc;
    ...
    const ctx = gsap.context(() => {
      ...
      mm.add("(min-width: 768px)", () => {
        ...
        gsap.set(logoWrapperRef.current, {
          ...
          clipPath: "inset(0% 0% 25% 0%)", scale: 0.15, opacity: 0, zIndex: 100
        });
        ...
        tl.addLabel("portal", "+=1.5")
          ...
          .to(".right-mask-portal", { 
            left: `calc(${cfg.portalLogoLeft} + 16%)`, 
            width: `calc(100% - ${cfg.portalLogoLeft} - 16%)`, 
